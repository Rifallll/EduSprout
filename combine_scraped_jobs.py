...
INPUT_FILES = [
    ...
    "src/data/jobs_from_lokerid.json"    # New: Data from Loker.id
...
print(f"✅ {len(final_jobs_list)} combined jobs exported to {OUTPUT_PATH} at {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")